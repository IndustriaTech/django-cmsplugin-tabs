...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CMSTabsList.template'
        db.add_column('cmsplugin_cmstabslist', 'template',
                      self.gf('django.db.models.fields.CharField')(default='cmsplugin_tabs/tabs.html', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CMSTabsList.template'
        db.delete_column('cmsplugin_cmstabslist', 'template')
