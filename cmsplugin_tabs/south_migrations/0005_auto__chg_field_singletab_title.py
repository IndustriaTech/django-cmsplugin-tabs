...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SingleTab.title'
        db.alter_column('cmsplugin_tabs_singletab', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'SingleTab.title'
        db.alter_column('cmsplugin_tabs_singletab', 'title', self.gf('django.db.models.fields.CharField')(max_length=64))
