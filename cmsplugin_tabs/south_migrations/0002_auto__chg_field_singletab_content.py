...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cmsplugin_tabs_singletab', 'content', self.gf('djangocms_text.fields.HTMLField')())

    def backwards(self, orm):

        # Changing field 'SingleTab.content'
        db.alter_column('cmsplugin_tabs_singletab', 'content', self.gf('django.db.models.fields.TextField')())
